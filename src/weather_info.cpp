...
const std::string &WeatherInfo::temperature() {
    return m_temperature;
}

const std::string &WeatherInfo::precipitation() {
    return m_precipitation;
}

const std::string &WeatherInfo::wind() {
    return m_wind;
}

const std::string &WeatherInfo::humidity() {
    return m_humidity;
}
